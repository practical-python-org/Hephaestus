"""
This command grabs info from a user, sends it to app/utility/_embeds
...
from app.utility._db_functions import see_user_data
from app.utility._embeds import embed_user_profile


class DBgetUser(commands.Cog):
    """
    Directly sends a query to our DB using Fn see_user_data(),
    located in app/utility/_db_functions
    """
...
def setup(bot):
    """
    Necessary for loading the cog into the app instance.
    """
