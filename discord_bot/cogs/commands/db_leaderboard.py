...
from discord_bot.utility._db_functions import see_top_10
from discord_bot.utility._embeds import embed_leaderboard


class DBleaders(commands.Cog):
    """
    Grabs the top 10 using discord_bot/utility/_db_functions/see_top_10
    embed uses discord_bot/utility/_embeds/embed_leaderboard
    """
